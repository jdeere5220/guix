...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_16bpp_compressed_glyph_1bit_  */
/*    draw                                                                */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
...
VOID                 (*blend_func)(GX_DRAW_CONTEXT *, INT, INT, GX_COLOR, GX_UBYTE);
    ...
    {
        _gx_synergy_simulation_display_driver_16bpp_glyph_1bit_draw(context, draw_area, map_offset, glyph);
    }
}
