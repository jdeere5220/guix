...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_32bpp_horizontal              */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_32bpp_horizontal_pixelmap_line_compressed_write(GX_DRAW_CONTEXT *context,
...
VOID               (*blend_func)(GX_DRAW_CONTEXT *context, INT x, INT y, GX_COLOR color, GX_UBYTE alpha);
    ...
    write_func = context -> gx_draw_context_display -> gx_display_driver_pixel_write;
...
/*                                                                        */
/**************************************************************************/
VOID _gx_synergy_simulation_display_driver_32bpp_horizontal_pixelmap_line_draw(GX_DRAW_CONTEXT *context,
                                                                               INT xstart, INT xend, INT y, GX_FILL_PIXELMAP_INFO *info)
{
...
GX_BOOL synergy_specific_format = GX_FALSE;
    ...
    if (info -> pixelmap -> gx_pixelmap_flags & GX_PIXELMAP_COMPRESSED)
    {
        ...
        _gx_synergy_simulation_display_driver_32bpp_horizontal_pixelmap_line_compressed_write(context, xstart, xend, y, info);
        drawn = GX_TRUE;
    }
