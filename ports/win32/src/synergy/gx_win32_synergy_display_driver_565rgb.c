...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    win32_synergy_simulation_565rgb_bitmap_header_create                */
/*                                                         PORTABLE C     */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*                                                                        */
/**************************************************************************/
static void win32_synergy_simulation_565rgb_bitmap_header_create(GX_DISPLAY *display)
{
DWORD                        *putmask;
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    win32_synergy_graphics_driver_setup_565rgb          PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Kenneth Maxwell, Microsoft Corporation                              */
...
GX_WIN32_DISPLAY_DRIVER_DATA *data;
    ...
    _gx_synergy_simulation_display_driver_565rgb_setup(display, data, gx_win32_display_buffer_toggle);
    ...
    win32_synergy_simulation_565rgb_bitmap_header_create(display);
