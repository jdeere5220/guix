...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    win32_synergy_simulation_24xrgb_bitmap_header_create                */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  CALLED BY                                                             */
/*                                                                        */
/*    win32_synergy_graphics_driver_setup_24xrgb                          */
/*                                                                        */
/*  RELEASE HISTORY                                                       */
/*                                                                        */
...
/*                                                                        */
/**************************************************************************/
static void win32_synergy_simulation_24xrgb_bitmap_header_create(GX_DISPLAY *display)
{
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    win32_synergy_graphics_driver_setup_24xrgb          PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Kenneth Maxwell, Microsoft Corporation                              */
...
/*  CALLS                                                                 */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_24xrgb_setup                  */
...
GX_WIN32_DISPLAY_DRIVER_DATA *data;
    ...
    _gx_synergy_simulation_display_driver_24xrgb_setup(display, data, gx_win32_display_buffer_toggle);
    ...
    win32_synergy_simulation_24xrgb_bitmap_header_create(display);
    return(GX_SUCCESS);
}
#endif /* WIN32 */
