...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_s_display_driver_synergy_24xrgb_pixelmap_c_a_write      */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_24xrgb_pixelmap_compressed_write(GX_DRAW_CONTEXT *context,
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synegy_s_display_driver_32bpp_4444argb_synergy_pixelmap_c       */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_32bpp_4444argb_pixelmap_compressed_alpha_write(GX_DRAW_CONTEXT *context,
                                                                                                 INT xpos, INT ypos, GX_PIXELMAP *pixelmap)
{
INT             yval;
INT             xval;
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_s_display_driver_32bpp_4444bgra_synergy_pixelmap_c_     */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_32bpp_4444bgra_pixelmap_compressed_write(GX_DRAW_CONTEXT *context,
                                                                                           INT xpos, INT ypos, GX_PIXELMAP *pixelmap)
{
INT             yval;
INT             xval;
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_s_display_driver_24xrgb_565rgb_pixelmap_c_write         */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_24xrgb_565rgb_pixelmap_compressed_write(GX_DRAW_CONTEXT *context,
                                                                                          INT xpos, INT ypos, GX_PIXELMAP *pixelmap)
{
INT                yval;
INT                xval;
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_s_display_driver_24xrgb_pixelmap_draw   PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Kenneth Maxwell, Microsoft Corporation                              */
...
/*  CALLS                                                                 */
/*                                                                        */
/*     _gx_synergy_display_driver_24xrgb_pixelmap_compressed_alpha_write  */
/*     _gx_display_driver_32bpp_4444argb_synergy_pixelmap_compressed      */
/*     _alpha_write                                                       */
/*     _gx_display_driver_32bpp_4444bgra_synergy_pixelmap_compressed      */
/*     _alpha_write                                                       */
...
GX_UBYTE brush_alpha = context -> gx_draw_context_brush.gx_brush_alpha;
    ...
    case GX_COLOR_FORMAT_24XRGB:
        if (pixelmap -> gx_pixelmap_flags & GX_PIXELMAP_COMPRESSED)
        {
            ...
            _gx_synergy_simulation_display_driver_24xrgb_pixelmap_compressed_write(context, xpos, ypos, pixelmap);
            drawn = GX_TRUE;
        }
        break;
    ...
    case GX_COLOR_FORMAT_4444ARGB:
        if (pixelmap -> gx_pixelmap_flags & GX_PIXELMAP_COMPRESSED)
        {
            ...
            _gx_synergy_simulation_display_driver_32bpp_4444argb_pixelmap_compressed_alpha_write(context, xpos, ypos, pixelmap);
            drawn = GX_TRUE;
        }
        break;
    ...
    case GX_COLOR_FORMAT_4444BGRA:
        ...
        {
            /* compressed with alpha */
            _gx_synergy_simulation_display_driver_32bpp_4444bgra_pixelmap_compressed_write(context, xpos, ypos, pixelmap);
            drawn = GX_TRUE;
        }
        break;
    ...
    case GX_COLOR_FORMAT_565RGB:
        if (pixelmap -> gx_pixelmap_flags & GX_PIXELMAP_COMPRESSED)
        {
            ...
            _gx_synergy_simulation_display_driver_24xrgb_565rgb_pixelmap_compressed_write(context, xpos, ypos, pixelmap);
            drawn = GX_TRUE;
        }
        break;
