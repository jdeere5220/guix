...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_32bpp_compressed_glyph_1bit_  */
/*    draw                                                                */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
...
GX_UBYTE brush_alpha = context -> gx_draw_context_brush.gx_brush_alpha;
                            ...
                            for (index = 0; index < 8; index++)
                            {
                                ...
                                if (alpha != 0)
                                {
                                        ...
                                        (col >= draw_area -> gx_rectangle_left))
                                    {
                                        ...
                                        if (brush_alpha != 0xff)
                                        {
                                            context -> gx_draw_context_display -> gx_display_driver_pixel_blend(context, col, row, text_color, brush_alpha);
                                        }
                                        else
                                        {
#endif
    ...
    {
        _gx_synergy_simulation_display_driver_32bpp_glyph_1bit_draw(context, draw_area, map_offset, glyph);
    }
}
