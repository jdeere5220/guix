...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_565rgb_pixelmap_c_write       */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_565rgb_pixelmap_compressed_write(GX_DRAW_CONTEXT *context,
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_16bpp_4444argb_pixelmap_      */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_16bpp_4444argb_pixelmap_compressed_alpha_write(GX_DRAW_CONTEXT *context,
                                                                                                 INT xpos, INT ypos, GX_PIXELMAP *pixelmap)
{
INT             yval;
INT             xval;
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_16bpp_4444bgra_pixelmap_      */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_16bpp_4444bgra_pixelmap_compressed_alpha_write(GX_DRAW_CONTEXT *context,
                                                                                                 INT xpos, INT ypos, GX_PIXELMAP *pixelmap)
{
INT             yval;
INT             xval;
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_16bpp_32argb_pixelmap_        */
/*    compressed_write                                                    */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_16bpp_32argb_pixelmap_compressed_write(GX_DRAW_CONTEXT *context,
                                                                                         INT xpos, INT ypos, GX_PIXELMAP *pixelmap)
{
INT             yval;
INT             xval;
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_16bpp_32argb_pixelmap         */
/*    _raw_write                                                          */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_16bpp_32argb_pixelmap_raw_write(GX_DRAW_CONTEXT *context,
                                                                                  INT xpos, INT ypos, GX_PIXELMAP *pixelmap)
{
INT                skipcount;
INT                xval;
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_565rgb_pixelmap_blend         */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  CALLS                                                                 */
/*                                                                        */
/*     _gx_synergy_simulation_display_driver_16bpp_32argb_pixelmap_r_write*/
/*     _gx_synergy_simulation_display_driver_16bpp_32argb_pixelmap_c_write*/
/*     _gx_synergy_simulation_display_driver_16bpp_4444argb_pixelmap      */
...
/*                                                                        */
/**************************************************************************/
VOID _gx_synergy_simulation_display_driver_565rgb_pixelmap_blend(GX_DRAW_CONTEXT *context,
...
GX_BOOL drawn = GX_FALSE;
    ...
    case GX_COLOR_FORMAT_565BGR:
        if (pixelmap -> gx_pixelmap_flags & GX_PIXELMAP_COMPRESSED)
        {
            ...
            _gx_synergy_simulation_display_driver_565rgb_pixelmap_compressed_write(context, xpos, ypos, pixelmap);
            drawn = GX_TRUE;
        }
        break;
    ...
    case GX_COLOR_FORMAT_4444ARGB:
        if (pixelmap -> gx_pixelmap_flags & GX_PIXELMAP_COMPRESSED)
        {
            ...
            _gx_synergy_simulation_display_driver_16bpp_4444argb_pixelmap_compressed_alpha_write(context, xpos, ypos, pixelmap);
            drawn = GX_TRUE;
        }
        break;
    ...
    case GX_COLOR_FORMAT_4444BGRA:
        ...
        {
            /* compressed with alpha */
            _gx_synergy_simulation_display_driver_16bpp_4444bgra_pixelmap_compressed_alpha_write(context, xpos, ypos, pixelmap);
            drawn = GX_TRUE;
        }
        break;
    ...
    case GX_COLOR_FORMAT_24XRGB:
        ...
        {
            /* compressed with alpha */
            _gx_synergy_simulation_display_driver_16bpp_32argb_pixelmap_compressed_write(context, xpos, ypos, pixelmap);
            drawn = GX_TRUE;
        }
        else
        {
            _gx_synergy_simulation_display_driver_16bpp_32argb_pixelmap_raw_write(context, xpos, ypos, pixelmap);
            drawn = GX_TRUE;
        }
        break;
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_16bpp_pixelmap_draw           */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
...
VOID _gx_synergy_simulation_display_driver_16bpp_pixelmap_draw(GX_DRAW_CONTEXT *context,
                                                               INT xpos, INT ypos, GX_PIXELMAP *pixelmap)
{
    _gx_synergy_simulation_display_driver_565rgb_pixelmap_blend(context, xpos, ypos, pixelmap, context -> gx_draw_context_brush.gx_brush_alpha);
}
