...
/*                                                                        */
/**************************************************************************/
static void win32_synergy_simulation_565rgb_rotated_bitmap_header_create(GX_DISPLAY *display)
{
DWORD                        *putmask;
...
GX_WIN32_DISPLAY_DRIVER_DATA *data;
    ...
    _gx_synergy_simulation_display_driver_565rgb_rotated_setup(display, data, gx_win32_display_buffer_toggle);
    ...
    win32_synergy_simulation_565rgb_rotated_bitmap_header_create(display);
