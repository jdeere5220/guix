...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_24xrgb_pixelmap_c_a_blend     */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_24xrgb_pixelmap_compressed_alpha_blend(GX_DRAW_CONTEXT *context,
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_24xrgb_pixelmap_c_blend       */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_24xrgb_pixelmap_compressed_blend(GX_DRAW_CONTEXT *context,
                                                                                   INT xpos, INT ypos, GX_PIXELMAP *pixelmap, GX_UBYTE alpha)
{
INT                xval;
INT                yval;
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_24xrgb_pixelmap_blend         */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*                                                                        */
/**************************************************************************/
VOID _gx_synergy_simulation_display_driver_24xrgb_pixelmap_blend(GX_DRAW_CONTEXT *context,
                                                                 INT xpos, INT ypos, GX_PIXELMAP *pixelmap, GX_UBYTE alpha)
{
...
GX_BOOL drawn = GX_FALSE;
    ...
    if (pixelmap -> gx_pixelmap_flags & GX_PIXELMAP_COMPRESSED)
    {
        ...
        {
            _gx_synergy_simulation_display_driver_24xrgb_pixelmap_compressed_alpha_blend(context, xpos, ypos, pixelmap, alpha);
        }
        else
        {
            _gx_synergy_simulation_display_driver_24xrgb_pixelmap_compressed_blend(context, xpos, ypos, pixelmap, alpha);
        }
        drawn = GX_TRUE;
    }
