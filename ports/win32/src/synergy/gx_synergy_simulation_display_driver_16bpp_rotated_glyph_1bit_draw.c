...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_synergy_simulation_display_driver_16bpp_rotated_glyph_1bit_raw_ */
/*                                                                   draw */
/*                                                                        */
/*                                                        PORTABLE C      */
/*                                                           6.x          */
...
VOID     (*blend_func)(GX_DRAW_CONTEXT *, INT, INT, GX_COLOR, GX_UBYTE);
    ...
    num_bytes = num_bytes - (UINT)((UINT)(rotated_map_offset_x) >> 3);

    /* Compute the number of pixels to draw from the first byte of the glyph data. */
    pixel_in_first_byte = (UINT)(8 - ((UINT)(rotated_map_offset_x) & 0x7));
    ...
    {
        if ((rotated_map_offset_x + (GX_VALUE)pixel_per_row) < 8)
        {
    ...
    {
        glyph_row = glyph_row + ((GX_VALUE)glyph_width * rotated_map_offset_y);
    }
