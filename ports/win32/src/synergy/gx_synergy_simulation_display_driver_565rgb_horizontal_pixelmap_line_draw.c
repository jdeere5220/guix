...
/*                                                                        */
/**************************************************************************/
static VOID _gx_synergy_simulation_display_driver_565rgb_horizontal_pixelmap_line_compressed_write(GX_DRAW_CONTEXT *context,
...
/*                                                                        */
/**************************************************************************/
VOID _gx_synergy_simulation_display_driver_565rgb_horizontal_pixelmap_line_draw(GX_DRAW_CONTEXT *context,
                                                                                INT xstart, INT xend, INT y, GX_FILL_PIXELMAP_INFO *info)
{
...
GX_PIXELMAP *pixelmap = info -> pixelmap;
    ...
    {
        _gx_synergy_simulation_display_driver_565rgb_horizontal_pixelmap_line_compressed_write(context, xstart, xend, y, info);
        drawn = GX_TRUE;
    }
