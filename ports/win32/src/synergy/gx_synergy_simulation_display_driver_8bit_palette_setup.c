                                                              ...
                                                              VOID (*toggle_function)(struct GX_CANVAS_STRUCT *canvas, GX_RECTANGLE *dirty_area))
{
    ...
    display -> gx_display_driver_4bit_glyph_draw = _gx_synergy_simulation_display_driver_8bpp_glyph_4bit_draw;
    display -> gx_display_driver_1bit_glyph_draw = _gx_synergy_simulation_display_driver_8bpp_glyph_1bit_draw;
}
